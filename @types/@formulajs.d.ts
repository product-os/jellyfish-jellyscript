...
declare module '@formulajs/formulajs' {
	...
	function PROPERTY(obj: object, path: Array<string | number> | string, defaultValue?: any): any;
	function FLATMAP<T>(collection: Array<T> | object, iteratee?: (item: T) => T): any;
	function UNIQUE<T>(array: Array<T>): Array<T>;
	function REGEX_MATCH(regex: string | RegExp, str: string): RegExpMatchArray | null;
